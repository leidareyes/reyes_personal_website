...
<div class="logo-section">
        <img src="https://tinyurl.com/2s44e3k4" alt="Logo">
    </div>

<div class="container">
    
    <h2><a href="index.php" class="btn btn-secondary back-button">Back</a></h2>
    <h2>Registration</h2>
...
?>
    ...
    <!-- Link to Login Page -->
<p style="margin-top: 20px;"> Already have an account? <a href="index.php" style="color: Brown;">Login</a></p>
