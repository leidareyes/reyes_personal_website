...
if(isset($_POST["login"])){
    ...
    if ($users){
        if(password_verify($password, $users["password"])){
            ...
            $successMessage = "<div class='alert alert-success'> You are Logged in Successfully! </div>"; // Corrected message for successful login
        } else {
            $errorMessage = "<div class='alert alert-danger'>Password does not match</div>"; // Corrected error message
        }
    } else {
        $errorMessage = "<div class='alert alert-danger'>Email does not exist</div>"; // Corrected error message
    }
}
?>
...
<!-- End About Section -->
  ...
  <div class="w3-padding-32 w3-content w3-text-grey" id="contact" style="margin-bottom:64px">
    ...
    echo '<div style="background-color: #dff0d8; color: #3c763d; padding: 10px; margin-bottom: 20px; text-align: center; animation: popUp 0.5s ease forwards;">';
...
<a href="logout.php"><button id="logoutButton" class="button">Logout</button></a>
